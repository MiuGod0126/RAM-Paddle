...
### 注：不要用weight decay，会影响模型（optimizer里没添加）
train_arg.add_argument(
    "--weight_decay",
    type=float,
    default=0.0,
...
misc_arg.add_argument(
    ...
    type=str2bool,
    default=True,
    help="Whether to resume lr from checkpoint or use init_lr",
)
misc_arg.add_argument(
    "--print_freq",
    type=int,
...
misc_arg.add_argument(
    ...
    type=int,
    default=10,
    help="How frequently to save ckpt(epoch)",
)
misc_arg.add_argument(
